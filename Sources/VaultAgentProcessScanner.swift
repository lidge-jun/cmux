...
extension RestorableAgentSessionIndex {
    ...
    private static func processDetectionShouldPreferOpenCodeOnBuiltinConflict(
        ...
        for candidate in candidates where candidate.panelKey == panelKey && candidate.process.isForegroundProcess {
    ...
    private static func processDetectedClaudeSnapshots(
        candidates: [RestorableAgentProcessDetectionCandidate],
    ...
    private static func claudeLaunchCommand(
        ...
        if let inheritedLauncher,
           !claudeLaunchKindAllowsInheritedCommand(inheritedLauncher) {
            return nil
        }
        if let inheritedLauncher,
    ...
    private static func claudeLaunchKindAllowsInheritedCommand(_ launcher: String) -> Bool {
        switch normalizedLaunchKind(launcher) {
        case "", "claude", "claudeteams":
            return true
        default:
            return false
        }
